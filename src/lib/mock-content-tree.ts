 ...
 * roots, a branch category that is public only through its descendants, the
 * maximum authored depth, an empty leaf that stays out of public navigation,
 * both content variants, a secondary listing, and an unplaced draft.
 */
...
export const mockContentTreeInput: ContentTreeInput = {
  categories: [
    // Top level.
